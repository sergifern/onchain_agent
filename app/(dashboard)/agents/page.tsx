...
export default function ComingSoon() {
  return (
    <PageContainer title="My Agent" description="Create your own agents to automate your tasks">
      <div className="flex flex-col items-center justify-center mt-12 max-w-md mx-auto">
        <span className="pb-2 text-sm font-semibold text-muted-foreground">3m $ETHY required</span>
        ...
        <p className="mt-2 text-sm text-center">
          ...
          Join our waitlist to be the next to access!
        </p>
        <WaitlistCheck />
      </div>
    </PageContainer>
